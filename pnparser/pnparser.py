...
class PatchNotesParser(commands.Cog):
    ...
    @commands.group()
    async def pnparser(self, ctx) -> None:
    ...
    @pnparser.command()
    async def reparse(self, ctx) -> None:
    ...
    @pnparser.group()
    async def designer(self, ctx) -> None:
        """Commands to get information related to patch notes designers"""

    @designer.command()
    async def geticon(self, ctx, designer_name: str) -> None:
        """Get the icon used for the specified designer"""
        await ctx.send(f"`{Designer.get_designer_icon(designer_name)}`")

    @designer.command()
    async def seticon(self, ctx, designer_name: str, designer_icon: str) -> None:
        """Set a new icon for the specified designer"""
        # TODO: Set new icon

    @designer.command()
    async def add(self, ctx, designer_name: str, designer_icon: str) -> None:
    ...
    @pnparser.group()
    async def ddragon(self, ctx) -> None:
    ...
    @pnparser.group()
    async def parse(self, ctx) -> None:
        """Commands to parse League of Legends patch notes"""

    @parse.command()
    async def all(self, ctx, patch_version: str) -> None:
        ...
        for designer_span in soup.find_all("span", {"class": "context-designer"}):
            designer = Designer(designer_span.text.strip())
    ...
    @parse.command()
    async def midpatch(self, ctx, patch_version: str) -> None:
